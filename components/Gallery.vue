<template>
  <div>
    ...
    <div class="md:flex flex-wrap w-full mt-10 md:-mx-6">
      <div
        v-for="(image, i) in pictures"
        :key="i"
        class="md:w-1/2 md:px-6 pb-10"
      >
        <img :src="image" alt="image" class="block w-full h-full cursor-pointer" @click="index = i">
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted () {
    if (this.where === 'homepage') {
      ...
      this.pictures = [work1, work2, work3, work4, work5, work6, work7, work8, work9, work10, work11, work12]
    }
  }
}
</script>
